...
## Olá, eu sou o Moddey <img src="https://github.com/atCode/TheDudeThatCode/blob/master/Assets/Hi.gif" width="29px">
...
> git clone https://github.com/moddeyalmeida/botmoddey.git   (baixa os arquivos do bot)
> cd botmoddey (abre a pasta do bot)
> bash install.sh     (para instalar todas as dependências)

```

## Preview bash
![Screenshot gif](https://raw.githubusercontent.com/igif-2-849390a68d2e.gif?token=ASS7GTNGGHJ6NMRRNR26KXTASK33A)
